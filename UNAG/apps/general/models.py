...
class persona(models.Model):
	...
	correo_electronico=models.EmailField(max_length=256, verbose_name = "Correo electrónico", unique = True)
	celular=models.CharField(max_length=8, validators=[validar(tipo='telefono', longitud=8)])
