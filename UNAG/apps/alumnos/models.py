...
class Becas(models.Model):
	descripcion=models.CharField(max_length=128)
	usuario_creador=models.ForeignKey(User, related_name='bc_usuario_creador')
	fecha_creacion=models.DateField(auto_now_add=True)
	usuario_modificador=models.ForeignKey(User, related_name='bc_usuario_modificador')
	fecha_modificacion=models.DateField(auto_now=True)
...
class Etnias(models.Model):
	descripcion=models.CharField(max_length=128)
	usuario_creador=models.ForeignKey(User, related_name='et_usuario_creador')
	fecha_creacion=models.DateField(auto_now_add=True)
	usuario_modificador=models.ForeignKey(User, related_name='et_usuario_modificador')
	fecha_modificacion=models.DateField(auto_now=True)
...
class Alumnos(models.Model):
	...
	identidad_padre=models.CharField(max_length=18,verbose_name=u'Identidad')
	nombre_padre=models.CharField(max_length=512, verbose_name=u'Nombre')
	profesion_padre=models.CharField(max_length=1024, verbose_name=u'Profesion u Oficio')
	telefono_padre=models.CharField(max_length=8, verbose_name=u'Telefono',  null = True, blank = True,default = None)
	asoc_campesina_padre=models.ForeignKey(AsocCampesina, verbose_name=u'Asociacion campesina', null = True, blank = True,default = None, related_name='padre_asoc_campesina')
	identidad_madre=models.CharField(max_length=18,verbose_name=u'Identidad')
	nombre_madre=models.CharField(max_length=512,verbose_name=u'Nombre', null = True, blank = True,default = None)
	profesion_madre=models.CharField(max_length=1024, verbose_name=u'Profesion u Oficio', null = True, blank = True,default = None)
	telefono_madre=models.CharField(max_length=8, verbose_name=u'Telefono', null = True, blank = True,default = None)
	asoc_campesina_madre=models.ForeignKey(AsocCampesina, verbose_name=u'Asociacion campesina', null = True, blank = True,default = None, related_name='madre_asoc_campesina')
	identidad_encargado=models.CharField(max_length=18,verbose_name=u'Identidad')
	nombre_encargado=models.CharField(max_length=512, verbose_name=u'Nombre')
	profesion_encargado=models.CharField(max_length=1024, verbose_name=u'Profesion u Oficio')
	telefono_encargado=models.CharField(max_length=8, verbose_name=u'Telefono', null = True, blank = True,default = None)
	...
	posicion_familiar=models.IntegerField(verbose_name=u'¿Que numero de hijo es usted (segun el orden de nacimiento)?', help_text='Especifique si es el primero (1), segundo (2), tercero (3) etc.')
	...
	beca=models.ForeignKey(Becas,related_name='alu_beca')
