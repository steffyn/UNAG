...
class Persona(models.Model):
	...
	Sangre_CHOICES = (('O+', 'O+'),('O-', 'O-'))
	identidad=models.CharField(max_length=18, unique = True)
	tipo_identificacion=models.ForeignKey(TipoIdentificacion, verbose_name = "Identificación")
	...
	direccion=models.TextField(max_length=2024, verbose_name = "Dirección")
	correo_electronico=models.EmailField(max_length=256, verbose_name = "Correo", unique = True)
	celular=models.CharField(max_length=8)
	telefono_fijo=models.CharField(max_length=8, verbose_name = "Teléfono fijo", null = True, blank = True,default = None)
